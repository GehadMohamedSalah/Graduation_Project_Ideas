//$(document).ready(function () { });
  ...
  //  compared_book = [];
  //  compared_book[0] = $(this)
  //    .closest("tr")
  //    .find(".title");
  //  compared_book[1] = $(this)
  //    .closest("tr")
  //    .find(".book_author");
  //  compared_book[2] = $(this)
  //    .closest("tr")
  //    .find(".book_year");
  //  compared_book[3] = $(this)
  //    .closest("tr")
  //    .find(".image");
  ...
  //function add() {
  //  table.prepend(
  //    '<tr><td><img class="image" src="' +
  //      book[3] +
  //      '"/></td><td><div class="title">' +
  //      book[0] +
  //      '</div><div class="book_author">' +
  //      book[1] +
  //      '</div><div><span class="book_year">' +
  //      book[2] +
  //      '</span><span class="year_format"> г.</span></div></td><td><p><button id="edit">Edit</button></p><p><button id="del">Delete</button></p></td></tr>'
  //  );
  //}
